...
| [Day 2](./src/bin/02.rs) | `46.6µs` | `59.5µs` |
| [Day 3](./src/bin/03.rs) | `371.7µs` | `442.5µs` |
| [Day 4](./src/bin/04.rs) | `237.3µs` | `234.6µs` |
| [Day 5](./src/bin/05.rs) | `34.0µs` | `293.1s` |
| [Day 6](./src/bin/06.rs) | `561.0ns` | `48.9ms` |
