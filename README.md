...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `98.8µs` | `1.9ms` |
| [Day 2](./src/bin/02.rs) | `45.5µs` | `66.1µs` |
| [Day 3](./src/bin/03.rs) | `398.3µs` | `386.9µs` |
| [Day 4](./src/bin/04.rs) | `219.3µs` | `246.7µs` |
| [Day 5](./src/bin/05.rs) | `28.2µs` | `294.7s` |
| [Day 6](./src/bin/06.rs) | `575.0ns` | `51.9ms` |
| [Day 7](./src/bin/07.rs) | `2.3ms` | `2.3ms` |
| [Day 8](./src/bin/08.rs) | `454.4µs` | `2.1ms` |
| [Day 9](./src/bin/09.rs) | `162.5µs` | `164.5µs` |
| [Day 10](./src/bin/10.rs) | `89.9µs` | `200.0µs` |
| [Day 11](./src/bin/11.rs) | `2.0ms` | `2.1ms` |
| [Day 12](./src/bin/12.rs) | `655.2µs` | `5.5ms` |
| [Day 13](./src/bin/13.rs) | `319.4µs` | `342.0µs` |
| [Day 14](./src/bin/14.rs) | `53.0µs` | `38.7ms` |
| [Day 15](./src/bin/15.rs) | `71.5µs` | `221.8µs` |
| [Day 16](./src/bin/16.rs) | `2.8ms` | `801.9ms` |
| [Day 17](./src/bin/17.rs) | `58.0ms` | `184.0ms` |
| [Day 18](./src/bin/18.rs) | `39.2µs` | `34.3µs` |
